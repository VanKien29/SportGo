...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('community_post_likes', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('post_id')->comment('Bài cộng đồng được thích.; VD: 10000000-0000-0000-0000-000000000001');
            $table->unsignedBigInteger('user_id')->comment('User bấm thích.; VD: 10000000-0000-0000-0000-000000000001');
