...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('owner_bank_accounts', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('owner_id')->comment('User chủ sân sở hữu tài khoản nhận tiền.');
            $table->unsignedBigInteger('partner_application_id')->nullable()->comment('Hồ sơ đăng ký chủ sân đã cung cấp tài khoản này.');
            ...
            $table->unsignedBigInteger('verified_by')->nullable()->comment('Admin xác minh tài khoản.');
