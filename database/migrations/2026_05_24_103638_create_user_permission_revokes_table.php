...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('user_permission_revokes', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('user_id')->comment('User bị thu hồi quyền, trỏ users.id.; VD: 10000000-0000-0000-0000-000000000001');
            ...
            $table->unsignedBigInteger('scope_id')->comment('ID pham vi thu hoi. Voi system dung 0; voi venue la venue_clusters.id.');
            $table->unsignedBigInteger('revoked_by')->nullable()->comment('Người thực hiện thu hồi quyền, trỏ users.id.; VD: 10000000-0000-0000-0000-000000000001');
