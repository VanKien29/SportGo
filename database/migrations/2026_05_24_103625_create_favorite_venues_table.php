...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('favorite_venues', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('user_id')->comment('User yêu thích cụm sân.; VD: 10000000-0000-0000-0000-000000000001');
            $table->unsignedBigInteger('venue_cluster_id')->comment('Cụm sân được user yêu thích.; VD: 10000000-0000-0000-0000-000000000001');
