    ...
    public function run(): void
    {
        ...
        $policies = [
            ...
            [
                ...
                'content' => "Chính sách này quy định điều kiện khách hoặc chủ sân được hủy booking.\n\nBooking đã check-in hoặc hoàn tất không được hủy thường. Chủ sân khi hủy booking phải nhập lý do. Nếu booking đã thanh toán hoặc đặt cọc, việc hủy có thể phát sinh yêu cầu hoàn tiền theo chính sách hoàn tiền.",
            ...
            [
                ...
                'type' => 'refund',
                'policy_type' => 'refund',
                'content' => "Chính sách này quy định cách tính mức hoàn tiền và thứ tự xử lý yêu cầu hoàn.\n\nKhách gửi yêu cầu hoàn tiền, chủ sân xác nhận đồng ý hoặc từ chối, sau đó admin mới xử lý và xác nhận hoàn tất. Admin không được chuyển yêu cầu sang hoàn tất nếu chủ sân chưa xác nhận.",
                'require_reaccept' => false,
                'is_overridable' => true,
                'priority' => 100,
            ],
