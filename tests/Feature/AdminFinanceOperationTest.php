...
class AdminFinanceOperationTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        config()->set('services.mbbank.withdraw_callback_api_key', 'test-mb-callback-key');
    ...
    public function test_withdrawal_approval_holds_balance_export_and_callback_complete_are_idempotent(): void
    {
        ...
        $this->withHeader('Authorization', 'Apikey test-mb-callback-key')
            ->postJson('/api/callback/bank/withdraw', $payload)
            ->assertOk()
            ->assertJsonPath('data.status', 'completed');
