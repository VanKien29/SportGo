    ...
    items: [
      {
        label: 'Bài đăng',
        icon: 'eye',
        to: '/admin/moderation?tab=moderation',
      ...
      },
      {
        ...
        activeNames: ['admin-moderation', 'admin-reports'],
      },
      {
        label: 'Khiếu nại',
        icon: 'shieldCheck',
        to: '/admin/moderation?tab=complaints',
        activeNames: ['admin-moderation', 'admin-complaints'],
      },
    ],
  },
];
...
export const adminRouteTitles = {
  ...
  'admin-reports': 'Kiểm duyệt & Báo cáo',
  'admin-complaints': 'Kiểm duyệt & Báo cáo',
