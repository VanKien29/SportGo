const ADMIN_ROUTE_REQUIREMENTS = {
  ...
  'admin-platform-fee-plan-detail': { all: ['platform_fee.view'] },
  'admin-platform-fee-ledgers': { all: ['platform_fee.view'] },
  'admin-platform-fee-ledger-detail': { all: ['platform_fee.view'] },
  'admin-platform-fee-arrangements': { all: ['platform_fee.view'] },
  'admin-platform-fee-promotions': { all: ['platform_fee.view'] },
