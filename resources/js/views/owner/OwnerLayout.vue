  ...
  <SidebarLayout brand-sub="Quản lý sân" dashboard-route="/owner/dashboard">
    <template #nav-items>
      ...
      <div class="owner-nav">
        ...
        <router-link to="/owner/profile" class="nav-item" active-class="nav-active">
          <AppIcon name="settings" size="18" />
          <span>Thông tin cá nhân</span>
        </router-link>
        <router-link to="/owner/partner-profile" class="nav-item" active-class="nav-active">
          <AppIcon name="fileText" size="18" />
          <span>Hồ sơ đối tác</span>
        </router-link>
        <router-link to="/owner/finance" class="nav-item" active-class="nav-active">
