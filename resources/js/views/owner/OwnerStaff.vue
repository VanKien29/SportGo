...
<style scoped>
.page{display:grid;gap:16px}.table-card,.modal{background: var(--admin-surface);border: 1px solid var(--admin-border);border-radius:12px}.table-card{overflow:auto}table{width:100%;border-collapse:collapse;min-width:880px}th,td{padding:12px;border-bottom: 1px solid var(--admin-border);text-align:left}.state{padding:24px;color: var(--admin-faint)}.btn,.mini-btn{border:0;border-radius:8px;font-weight:800;cursor:pointer}.btn{padding:10px 14px}.mini-btn{padding:7px 10px;margin-right:6px;background: var(--admin-surface-muted)}.primary{background:#16a34a;color:#fff}.secondary{background: var(--admin-surface-muted);color: var(--admin-text)}.danger{background:#fee2e2;color:#b91c1c}.badge{border-radius:999px;padding:5px 9px;font-size:12px;font-weight:800;background:#e2e8f0}.badge.active{background:#dcfce7;color:#166534}.badge.locked,.badge.deactivated{background:#fee2e2;color:#b91c1c}.alert{padding:12px;border-radius:10px;font-weight:700}.error{background:#fee2e2;color:#b91c1c}.success{background:#dcfce7;color:#166534}.modal-backdrop{position:fixed;inset:0;background:rgba(15,23,42,.56);display:grid;place-items:center;z-index:500;padding:20px}.modal{width:min(680px,calc(100vw - 32px));padding:22px;display:grid;gap:16px}.grid{display:grid;grid-template-columns:1fr 1fr;gap:12px}label{display:grid;gap:6px;font-weight:800}input,select{border:1px solid #dbe3ef;border-radius:8px;padding:10px;font:inherit}.scope-box{display:grid;gap:10px;border: 1px solid var(--admin-border);border-radius:10px;padding:12px}.scope-box>span{font-weight:900}.check{display:flex;align-items:center;gap:8px}.check input{width:auto}.court-types{display:grid;grid-template-columns:repeat(2,1fr);gap:8px}footer{display:flex;justify-content:flex-end;gap:10px}@media(max-width:720px){.grid,.court-types{grid-template-columns:1fr}}
</style>
