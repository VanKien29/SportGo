          ...
          <table>
            ...
            <tbody>
              <tr v-for="fee in filteredFees" :key="fee.id">
                <td>
                  {{ date(fee.period_start) }} - {{ date(fee.period_end) }}
...
<style scoped>
.fee-page{display:grid;gap:18px;max-width:1280px}.table-head,.payment-modal header,.payment-modal footer{display:flex;align-items:flex-start;justify-content:space-between;gap:16px}.table-head h3,.bank-card h3,.payment-modal h3{margin:0;color: var(--admin-text)}.table-head p,.muted{margin:6px 0 0;color: var(--admin-faint)}.eyebrow{margin:0 0 6px;color:#059669;font-size:11px;font-weight:900;letter-spacing:.11em}.refresh-btn,.submit-btn,.cancel-btn,.close-btn{border:0;border-radius:9px;font:inherit;font-weight:800;cursor:pointer}.refresh-btn,.cancel-btn{padding:10px 14px;background: var(--admin-surface-muted);color: var(--admin-text)}.submit-btn{padding:9px 13px;background:var(--admin-primary);color:var(--admin-bg)}.submit-btn:disabled,.refresh-btn:disabled{opacity:.55;cursor:not-allowed}.state-card,.table-card,.bank-card,.summary-card{background: var(--admin-surface);border: 1px solid var(--admin-border);border-radius:14px}.state-card{padding:34px;text-align:center;color: var(--admin-faint)}.alert,.deadline-alert{border-radius:12px;padding:14px 16px}.alert{font-weight:750}.alert.error{background:#fee2e2;color:#991b1b}.alert.success{background:#dcfce7;color:#166534}.deadline-alert{display:flex;align-items:center;gap:13px}.deadline-alert strong{display:block;margin-bottom:4px}.deadline-alert strong, .deadline-alert p{margin:0;font-size:13px;color:inherit}.overdue-alert{background:var(--admin-danger-soft);border:1px solid var(--admin-danger);color:var(--admin-danger-text)}.due-alert{background:var(--admin-warning-soft);border:1px solid var(--admin-warning);color:var(--admin-warning)}.alert-icon{display:grid;place-items:center;width:30px;height:30px;flex:0 0 30px;border:2px solid currentColor;border-radius:50%;font-weight:900}.summary-grid{display:grid;grid-template-columns:1.45fr repeat(3,1fr);gap:14px}.summary-card{display:grid;gap:7px;padding:19px}.summary-card span,.summary-card small{color: var(--admin-faint)}.summary-card strong{font-size:24px;color: var(--admin-text)}.primary-card{border-color:var(--admin-border);background:var(--admin-surface-muted)}.primary-card strong{color:var(--admin-text)}.danger-text{color:#dc2626!important}.bank-card{display:flex;justify-content:space-between;gap:24px;padding:20px}.bank-card dl{display:grid;grid-template-columns:repeat(3,minmax(130px,1fr));gap:24px;margin:0}.bank-card dl div{display:grid;gap:5px}.bank-card dt{color: var(--admin-faint);font-size:12px}.bank-card dd{margin:0;color: var(--admin-text);font-weight:850}.table-card{overflow:hidden}.table-head{padding:18px 20px;border-bottom: 1px solid var(--admin-border)}.table-actions{display:flex;align-items:center;gap:12px}.table-head select{border: 1px solid var(--admin-border);border-radius:9px;padding:9px 12px;background: var(--admin-surface);font:inherit;color: var(--admin-text)}.table-wrap{overflow:auto}table{width:100%;min-width:1050px;border-collapse:collapse}th,td{padding:14px 16px;border-bottom: 1px solid var(--admin-border);text-align:left;vertical-align:top}th{background: var(--admin-surface-muted);color: var(--admin-faint);font-size:11px;text-transform:uppercase;letter-spacing:.04em}td{color: var(--admin-text);font-size:13px}td strong,td small,td a{display:block}td small{margin-top:5px;color: var(--admin-faint)}td a{margin-top:5px;color:#047857;font-weight:750;text-decoration:none}.status-pill{display:inline-flex;border-radius:999px;padding:5px 9px;font-size:11px;font-weight:850}.status-pill.pending{background:#fef3c7;color:#92400e}.status-pill.overdue{background:#fee2e2;color:#991b1b}.status-pill.paid{background:#dcfce7;color:#166534}.status-pill.cancelled{background:#e2e8f0;color: var(--admin-faint)}.action-cell{text-align:right}.empty-state{padding:40px;text-align:center;color: var(--admin-faint)}.modal-backdrop{position:fixed;inset:0;z-index:600;display:grid;place-items:center;padding:20px;background:rgba(15,23,42,.58)}.payment-modal{display:grid;gap:16px;width:min(570px,calc(100vw - 32px));padding:22px;border-radius:16px;background: var(--admin-surface);box-shadow:0 24px 70px rgba(15,23,42,.28)}.close-btn{padding:2px 8px;background:transparent;color: var(--admin-faint);font-size:25px}.amount-box{display:flex;justify-content:space-between;align-items:center;padding:14px;border-radius:10px;background:#ecfdf5;color:#065f46}.amount-box strong{font-size:20px}.review-note{margin:0;padding:12px;border-radius:9px;background: var(--admin-surface-muted);color: var(--admin-faint);font-size:13px;line-height:1.5}.payment-modal footer{justify-content:flex-end}.payment-modal .cancel-btn{padding:9px 14px}@media(max-width:1050px){.summary-grid{grid-template-columns:repeat(2,1fr)}.bank-card{display:grid}.bank-card dl{grid-template-columns:repeat(3,1fr)}}@media(max-width:680px){.table-head{display:grid;gap:12px}.table-actions{display:grid;grid-template-columns:1fr;gap:8px}.summary-grid{grid-template-columns:1fr}.bank-card dl{grid-template-columns:1fr;gap:12px}.refresh-btn,.table-head select{width:100%}}
.qr-payment{display:grid;grid-template-columns:150px 1fr;gap:16px;align-items:center;padding:14px;border:1px solid #a7f3d0;border-radius:12px;background:#f0fdf4}.qr-payment img{display:block;width:150px;height:150px;border-radius:8px;background: var(--admin-surface);object-fit:contain}.qr-payment div{display:grid;gap:7px;color: var(--admin-faint);font-size:13px}.qr-payment strong{color:#065f46;font-size:15px}.copy-btn{justify-self:start;border:0;padding:0;background:transparent;color:#047857;font:inherit;font-weight:850;text-decoration:underline;cursor:pointer}.auto-status{display:inline-flex;border-radius:999px;padding:5px 9px;background:#dbeafe;color:#1d4ed8;font-size:11px;font-weight:850}.auto-status.paid{background:#dcfce7;color:#166534}.paid-at{color: var(--admin-faint);font-size:12px;font-weight:750}.auto-note{display:flex;align-items:center;gap:9px;background:#eff6ff;color:#1e40af}.poll-dot{width:9px;height:9px;flex:0 0 9px;border-radius:50%;background:#2563eb;box-shadow:0 0 0 0 rgba(37,99,235,.45);animation:poll-pulse 1.5s infinite}@keyframes poll-pulse{70%{box-shadow:0 0 0 8px rgba(37,99,235,0)}100%{box-shadow:0 0 0 0 rgba(37,99,235,0)}}@media(max-width:560px){.qr-payment{grid-template-columns:1fr}.qr-payment img{margin:auto}}
</style>
