...
<style scoped>
.page{display:grid;gap:16px}.filters{display:flex;justify-content:space-between;gap:12px;align-items:flex-start}.filters{justify-content:flex-start;align-items:center}.filters input,.filters select{border:1px solid #dbe3ef;border-radius:8px;padding:10px;font:inherit}.notice{background:#eff6ff;border:1px solid #bfdbfe;color:#1d4ed8;border-radius:10px;padding:12px;font-weight:800}.table-card,.modal{background: var(--admin-surface);border: 1px solid var(--admin-border);border-radius:12px}.table-card{overflow:auto}table{width:100%;border-collapse:collapse;min-width:1040px}th,td{padding:12px;border-bottom: 1px solid var(--admin-border);text-align:left}.state{padding:24px;color: var(--admin-faint)}.btn,.mini-btn{border:0;border-radius:8px;font-weight:800;cursor:pointer}.btn{padding:10px 14px}.mini-btn{padding:7px 10px;margin-right:6px;background: var(--admin-surface-muted)}.primary{background:#16a34a;color:#fff}.secondary{background: var(--admin-surface-muted);color: var(--admin-text)}.danger{background:#fee2e2;color:#b91c1c}.badge{border-radius:999px;padding:5px 9px;font-size:12px;font-weight:800;background:#e2e8f0}.badge.active{background:#dcfce7;color:#166534}.badge.inactive,.badge.expired{background:#fee2e2;color:#b91c1c}.badge.draft{background: var(--admin-surface-muted);color: var(--admin-faint)}.alert{padding:12px;border-radius:10px;font-weight:700}.error{background:#fee2e2;color:#b91c1c}.success{background:#dcfce7;color:#166534}.modal-backdrop{position:fixed;inset:0;background:rgba(15,23,42,.56);display:grid;place-items:center;z-index:500;padding:20px}.modal{width:min(760px,calc(100vw - 32px));padding:22px;display:grid;gap:16px}.grid{display:grid;grid-template-columns:1fr 1fr;gap:12px}label{display:grid;gap:6px;font-weight:800}input,select,textarea{border:1px solid #dbe3ef;border-radius:8px;padding:10px;font:inherit}footer{display:flex;justify-content:flex-end;gap:10px}@media(max-width:720px){.grid,.filters{grid-template-columns:1fr;flex-direction:column;align-items:stretch}}
</style>
