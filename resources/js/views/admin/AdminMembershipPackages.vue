<template>
  <section class="vip-admin-page">
    <div class="notice">Cấu hình gói VIP hệ thống, quyền lợi voucher, cashback và ưu tiên xử lý.</div>
...
<style scoped>
.vip-admin-page{display:grid;gap:16px}.notice,.alert,.state{padding:12px 14px;border-radius:10px;font-weight:750}.notice{background:#eff6ff;border:1px solid #bfdbfe;color:#1d4ed8}.alert.error{background:#fee2e2;color:#b91c1c}.alert.success{background:#dcfce7;color:#166534}.state{background:#fff;border:1px solid #e2e8f0;color:#64748b}.package-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px}.package-card{display:grid;gap:14px;padding:16px;border:1px solid #e2e8f0;border-radius:12px;background:#fff}.package-card header{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.package-card h3{margin:3px 0 0;color:#0f172a}.package-card header span{color:#059669;font-size:11px;font-weight:900;text-transform:uppercase}.grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}label{display:grid;gap:5px;color:#475569;font-size:12px;font-weight:800}input{height:38px;border:1px solid #cbd5e1;border-radius:8px;padding:0 10px;font:inherit}.toggle,.check{display:flex;align-items:center;gap:8px}.toggle input,.check input{width:16px;height:16px}.btn{border:0;border-radius:8px;padding:10px 14px;font-weight:850;cursor:pointer}.primary{background:#16a34a;color:#fff}.primary:disabled{opacity:.55;cursor:not-allowed}@media(max-width:1100px){.package-grid{grid-template-columns:1fr}.grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:620px){.grid{grid-template-columns:1fr}}
</style>
