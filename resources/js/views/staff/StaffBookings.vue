                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td>
                                <strong
                                    :class="{
                                        'text-danger': outstandingAmount(b) > 0,
                                    }"
                                >
                                    {{
                                        outstandingAmount(b) > 0
                                            ? formatCurrency(
                                                  outstandingAmount(b),
                                              )
                                            : "0đ"
                        ...
                        <tr v-if="!filteredBookingsList.length">
                            <td colspan="9" class="td-empty-list">
                        ...
                        <label class="pos-field">
                            ...
                            <input
                                ...
                                :disabled="
                                    ...
                                    !!pendingTransfer(collectBooking)
                                "
                                required
                            />
                        </label>
...
export default {
    ...
    methods: {
        ...
        canCollectPayment(booking) {
            return (
                !["cancelled", "expired", "rejected", "no_show"].includes(
                    booking.status,
                ) && this.outstandingAmount(booking) > 0
            );
        },
