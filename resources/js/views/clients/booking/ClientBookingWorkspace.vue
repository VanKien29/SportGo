...
@media(max-width:680px){.booking-summary{position:sticky;bottom:0;top:auto;z-index:10;max-height:82vh;overflow:auto;border-radius:10px 10px 0 0;box-shadow:0 -12px 30px rgba(15,49,26,.14)}}
</style>
