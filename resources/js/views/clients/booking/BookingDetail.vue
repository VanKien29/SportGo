<template>
    <div class="bd-page">
        ...
        <main class="bd-main">
            ...
            <!-- ERROR / EMPTY STATE -->
            <div
                v-else-if="!booking || loadError"
                class="bd-state bd-state--error"
            >
                <strong>Không tìm thấy thông tin booking</strong>
                <p>
                    {{
                        loadError ||
                        "Đơn đặt sân này không tồn tại hoặc đã bị gỡ khỏi hệ thống."
                    }}
                </p>
            ...
            <div v-else class="bd-content">
                ...
                <div class="bd-top-bar">
                    <div class="bd-title-group">
                        <h1 class="bd-title">
                            Chi tiết đơn đặt #{{ booking.booking_code }}
                        </h1>
                    </div>
                ...
                <div class="bd-grid">
                    ...
                    <div class="bd-col-main">
                        ...
                        <div class="bd-info-list">
                            <div class="bd-info-row">
                                ...
                                <strong class="bd-val">{{
                                    venueCluster?.name || "Cụm sân thể thao"
                                }}</strong>
                            </div>
                        ...
                        <div
                            v-if="booking.items?.length"
                            class="bd-slots-section"
                        >
                            <h4 class="bd-sub-title">
                            ...
                            <div class="bd-slots-list">
                                ...
                                >
                                    <div>
                                        ...
                                        <p>
                                            Số lượng: {{ srv.quantity }}
                                            {{ srv.unit || "lượt" }} x
                                            {{ formatPrice(srv.unit_price) }}
                                        </p>
                                    </div>
                                    <strong
                                        class="bd-val"
                    ...
                    <div class="bd-col-side">
                        ...
                        <div
                            ...
                            "
                            class="bd-timer-section"
                        >
                            <span class="bd-timer-label">{{
                                booking.status === "pending_approval"
                                    ? "Chủ sân còn thời gian duyệt:"
                                    : "Giữ chỗ tạm thời trong:"
                            }}</span>
                            <strong class="bd-timer-val">{{
                                formattedTimer
                            }}</strong>
                            <p>
                                {{
                        ...
                        <div class="bd-price-list">
                            ...
                            >
                                ...
                                >
                                <strong
                                    class="bd-price-val bd-price-val--green"
                                    >{{
                                        formatCurrency(
                                            booking.required_payment_amount,
                                        )
                                    }}</strong
                                >
                            </div>
                        ...
                        <div
                            ...
                            "
                            class="bd-ticket-panel"
                        >
                            <div class="bd-ticket-head">
                                <span class="bd-ticket-kicker"
                                    >VÉ NHẬN SÂN ĐIỆN TỬ</span
                                >
                                <strong class="bd-ticket-code"
                            ...
                            <p class="bd-ticket-hint">
                                Đưa mã QR này cho nhân viên tại quầy để nhận sân
                                nhanh chóng.
                            </p>
                        </div>
                        ...
                        <section
                            v-if="canPayOnline"
                            class="bd-payment-panel"
                            aria-labelledby="bd-payment-title"
                        >
                            ...
                            >
                                ...
                                <div class="bd-payment-body">
                                    <div class="bd-qr-wrap">
                                        ...
                                        <div v-else class="bd-qr-fallback">
                                            <strong
                                                >Không tải được ảnh QR</strong
                                            >
                                            <span
                                                >Vui lòng nhập thông tin chuyển
                                                khoản bên cạnh.</span
                                            >
                                        </div>
                                    </div>
                                ...
                                <p class="bd-payment-note">
                                    Chuyển đúng số tiền và nội dung để hệ thống
                                    tự động xác nhận thanh toán.
                                </p>
                                <p
                                    v-if="paymentWebhookListening"
                                    class="bd-payment-sync"
                                    role="status"
                                >
                                    <span
                                        class="bd-sync-dot"
                                ...
                                <p v-if="copySuccess" class="bd-copy-success">
                                    {{ copySuccess }}
                                </p>
                            </div>
                        </section>
                        ...
                        <div
                            v-if="canCancelPendingPayment"
                            class="bd-payment-cancel-action"
                        >
                            <button
                                type="button"
                            ...
                            <p class="bd-payment-cancel-hint">
                                Hủy đơn sẽ làm mã QR hết hiệu lực và giải phóng
                                khung giờ đang giữ.
                            </p>
                        </div>
        ...
        <Teleport to="body">
            <div
                ...
                @click.self="closeCancelBookingModal"
            >
                <div class="bd-modal">
                    ...
                    <div class="bd-modal-body">
                        ...
                        <div class="bd-field">
                            ...
                            <select id="bdCancelReason" v-model="cancelReason">
                                <option value="Khách hàng thay đổi kế hoạch">
                                    Khách hàng thay đổi kế hoạch
                                </option>
                                <option value="Thời tiết không thuận lợi">
                                    Thời tiết không thuận lợi
                                </option>
                                <option value="Muốn đổi giờ chơi khác">
                                    Muốn đổi giờ chơi khác
                                </option>
                ...
                >
                    ...
                    <div class="bd-modal-body">
                        <p class="bd-modal-desc">
                            ...
                            <strong>#{{ booking?.booking_code }}</strong> không?
                        </p>
                        <p class="bd-cancel-payment-copy">
                            Mã QR hiện tại sẽ không còn hiệu lực, khoản thanh
                            toán đang chờ sẽ bị hủy và khung giờ được mở lại.
                        </p>
                        <div
                ...
                <div class="bd-modal-content">
                    ...
                    <div class="bd-modal-body">
                        <div
                            ...
                            class="bd-modal-loading"
                        >
                            Đang tải danh sách dịch vụ tại sân...
                        </div>
                        <div
                            v-else-if="!availableVenueServices.length"
                            class="bd-modal-empty"
                        >
                            Cụm sân này chưa niêm yết dịch vụ tại sân.
                        </div>
                        <div v-else class="bd-modal-services-list">
                            <div
                                v-for="srv in availableVenueServices"
                                :key="srv.id"
                                class="cbw-service-item"
                            >
                                <div class="cbw-srv-info">
                                    <strong class="cbw-srv-name">{{
                                        srv.name
                                    }}</strong>
                                    <span class="cbw-srv-price"
                                ...
                                <div class="cbw-srv-qty">
                                    <button
                                        type="button"
                                        class="cbw-qty-btn"
                                        :disabled="!extraServiceQty(srv.id)"
                                        @click="updateExtraQty(srv, -1)"
                                    >
                                        -
                                    </button>
                                    <span class="cbw-qty-val">{{
                                        extraServiceQty(srv.id)
                                    }}</span>
                                    <button
                                        type="button"
                                        class="cbw-qty-btn"
                        ...
                        <p v-if="addServicesError" class="bd-modal-error">
                            {{ addServicesError }}
                        </p>
                    </div>
                    <div class="bd-modal-foot">
                        ...
                        >
                            <span>{{
                                submittingExtra
                                    ? "Đang gửi..."
                                    : `Xác nhận & Gửi (${formatPrice(extraServicesTotal)})`
                            }}</span>
                        </button>
                    </div>
                </div>
    ...
    computed: {
        ...
        statusDescription() {
            ...
            const map = {
                ...
                pending_payment:
                    "Vui lòng hoàn tất thanh toán trước khi hết giờ để giữ chỗ.",
                pending_approval: "Chủ sân đang duyệt đơn đặt của bạn.",
                checked_in:
                    "Bạn đã check-in tại sân. Chúc bạn có buổi chơi hiệu quả.",
                completed:
                    "Buổi chơi đã hoàn tất. Cảm ơn bạn đã sử dụng SportGo.",
                no_show:
                    "Booking đã quá giờ cho phép nhưng chưa ghi nhận check-in.",
                rejected:
                    "Booking không được sân chấp nhận. Vui lòng chọn khung giờ khác.",
        ...
        venueCluster() {
            return (
                this.booking?.venue_court?.venue_cluster ||
        ...
        venueId() {
            return (
                this.venueCluster?.id || this.booking?.venue_cluster_id || null
            );
        },
        venueAddress() {
            return (
                this.venueCluster?.full_address ||
        ...
        canRequestCancellation() {
            if (
                !["pending_approval", "confirmed"].includes(
                    this.booking?.status,
                )
            )
                return false;
            if (typeof this.booking?.can_cancel === "boolean")
                return this.booking.can_cancel;
        ...
        canPayOnline() {
            ...
            const depositStillDue =
                Number(this.booking?.paid_amount || 0) + 0.01 <
        ...
        paymentAccount() {
            return (
                ...
                this.paymentInfo?.system_bank_account ||
                {}
            );
        },
        paymentAmount() {
    ...
    methods: {
        async loadBooking() {
            ...
            try {
                ...
                this.timeLeft = Math.max(
                    0,
                    Math.floor(Number(res.time_left_seconds) || 0),
                );
        ...
        async loadPaymentInfo() {
            ...
            try {
                ...
                this.paymentInfo = null;
                this.paymentError =
                    err.message || "Không thể tạo mã QR thanh toán.";
            } finally {
        ...
        subscribeBookingPaymentChannel() {
            ...
            try {
                ...
                console.warn(
                    "Không thể đăng ký kênh cập nhật thanh toán booking:",
                    err,
                );
            }
        },
        ...
        async refreshBookingStatus() {
            ...
            try {
                ...
                const nextBooking = response?.data?.id
                    ? response.data
                    : response;
                if (
                    !nextBooking?.id ||
                    String(nextBooking.id) !== String(this.$route.params.id)
                )
                    return;
                ...
                this.timeLeft = Math.max(
                    0,
                    Math.floor(Number(nextBooking.time_left_seconds) || 0),
                );
        ...
        async cancelPendingPayment() {
            ...
            try {
                ...
                this.cancelPaymentError =
                    err.message || "Không thể hủy đơn chờ thanh toán.";
            } finally {
        ...
        async cancelBooking() {
            ...
            try {
                ...
                this.cancelBookingError =
                    err.message || "Không thể thực hiện hủy booking.";
            } finally {
