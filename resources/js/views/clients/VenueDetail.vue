        ...
        <main v-else-if="venue" class="venue-detail-main">
            <section class="hero-band">
                <div class="detail-container">
                    <router-link
                        class="venue-back-link !text-slate-800 !bg-white/80 hover:!bg-white !border-slate-300"
                        :to="{ name: 'venues', query: searchQuery }"
                    >
                        <AppIcon name="chevronLeft" size="16" />
                        Quay lại tìm sân
                    </router-link>
                    <nav
                        class="breadcrumbs !text-slate-500"
                        aria-label="Duong dan"
                    >
                        <router-link
                            :to="{ name: 'home' }"
                            class="!text-slate-700 hover:!text-emerald-700"
                    ...
                    <div class="hero-grid">
                        <div class="gallery">
                            <div class="gallery-main">
                                <img
                                    ...
                                    :src="activeImage"
                                    :alt="venue.name"
                                    @error="removeGalleryImage(activeImage)"
                                />
                                <div v-else class="gallery-empty">
                                    <img
                                        ...
                                        aria-hidden="true"
                                    />
                                    <div class="gallery-empty-overlay">
                                        <span
                                            ><AppIcon name="image" size="34"
                                        /></span>
                                        <strong>{{
                                            galleryState === "missing"
                                                ? "Chưa có ảnh sân"
                                                : "Không tải được ảnh sân"
                                        }}</strong>
                                        <small>{{
                                            galleryState === "missing"
                                                ? "Chủ sân chưa tải hình ảnh lên."
                                                : "Liên kết ảnh hiện không truy cập được."
                                        }}</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            >
                                ...
                                >
                                    <img
                                        :src="image"
                                        :alt="venue.name"
                                        @error="removeGalleryImage(image)"
                                    />
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="hero-copy">
                            ...
                            <div class="hero-actions">
                                ...
                                <button
                                    type="button"
                                    class="ghost-action favorite-action"
            ...
            <nav
                class="detail-container venue-tabs"
                aria-label="Nội dung chi tiết sân"
            >
                <button
                ...
                >
                    ...
                    {{ tab.label }}
                    <span v-if="tab.id === 'reviews' && reviewCount">{{
                        reviewCount
                    }}</span>
                </button>
            </nav>
            ...
            <section class="detail-container detail-layout">
                <div class="detail-main">
                    <section
                        v-if="activeTab === 'overview' && venue.description"
                    ...
                    <section
                        v-if="activeTab === 'overview' && amenities.length"
                        class="detail-section"
                    >
                        <h2>Tiện ích</h2>
                    ...
                    <section
                        v-if="activeTab === 'courts' && courtGroups.length"
                        class="detail-section"
                    >
                        <div class="court-layout-heading">
                            <div>
                                <h2>Sơ đồ sân</h2>
                                <p>
                                    Chọn sân trực tiếp trên sơ đồ để xem nhanh
                                    vị trí và loại sân.
                                </p>
                            </div>
                            <span class="court-layout-legend"
                                ><i></i>Sân đang hoạt động</span
                            >
                        </div>
                        <div
                            class="court-layout-canvas"
                            :style="layoutCanvasStyle"
                            aria-label="Sơ đồ trực quan các sân"
                        >
                            <button
                            ...
                            >
                                ...
                                <span>{{
                                    court.court_type?.name || "Sân thể thao"
                                }}</span>
                            </button>
                            <div
                            ...
                            >
                                <AppIcon
                                    :name="decorationIcon(decoration.type)"
                                    :size="16"
                                />
                        ...
                        <p
                            v-if="selectedLayoutCourt"
                            class="court-layout-selection"
                        >
                            Đang xem:
                            <strong>{{ selectedLayoutCourt.name }}</strong>
                            <span>{{
                                selectedLayoutCourt.court_type?.name ||
                                "Sân thể thao"
                            }}</span>
                        </p>
                    ...
                    <section
                        v-if="
                            activeTab === 'overview' && groupedServices.length
                        "
                        class="detail-section"
                    >
                        ...
                        <div class="section-heading-row">
                            <div>
                                <p class="section-eyebrow">
                                    Chi phí theo khung giờ
                                </p>
                                <h2>Bảng giá sân</h2>
                            </div>
                            <span class="section-heading-note"
                                >Đơn giá tính theo giờ</span
                            >
                        </div>
                        <div
                            class="price-list"
                            role="table"
                            aria-label="Bảng giá sân"
                        >
                            <div class="price-table-head" role="row">
                                <span role="columnheader">Sân / loại sân</span>
                                <span role="columnheader"
                                    >Khung giờ / ngày áp dụng</span
                                >
                                <span role="columnheader">Giá</span>
                            </div>
                            <article
                                v-for="price in basePrices"
                                :key="`base-${price.id}`"
                                role="row"
                            >
                                <span>{{
                                    price.court_type?.name || "Tất cả loại sân"
                                }}</span>
                                <span class="price-application"
                                    >Khung giờ cơ bản</span
                                >
                                <strong
                                    >{{
                            ...
                            <article
                                v-for="slot in priceSlots"
                                :key="`slot-${slot.id}`"
                                role="row"
                            >
                                <span>{{
                                    slot.court_type?.name || "Tất cả loại sân"
                                }}</span>
                                <span class="price-application"
                                    >{{ timeLabel(slot.start_time) }} -
                                    {{ timeLabel(slot.end_time) }}</span
                                >
                                <strong
                                    >{{
                            ...
                            <article
                                v-for="holiday in holidayPrices"
                                :key="`holiday-${holiday.id}`"
                                class="holiday-price-item"
                                role="row"
                            >
                                <span>{{
                                    holiday.court_type?.name ||
                                    "Tất cả loại sân"
                                }}</span>
                                <span class="price-application">
                                    {{
                                        holiday.date_type === "special_date"
                                            ? "Ngày đặc biệt"
                                            : "Ngày lễ"
                                    }}
                                    · {{ formatDate(holiday.holiday_date)
                                    }}<template v-if="holiday.start_time">
                                        · {{ timeLabel(holiday.start_time) }} -
                                        {{
                                            timeLabel(holiday.end_time)
                                        }}</template
                                    >
                                    <small v-if="holiday.note">{{
                                        holiday.note
                                    }}</small>
                                </span>
                                <strong
                    ...
                    >
                        <h2>Đánh giá</h2>
                        <form
                            v-if="eligibleReviews.length"
                            class="review-compose"
                        ...
                        >
                            <div class="review-compose-head">
                                <div>
                                    ...
                                    <span
                                        >Chỉ booking đã hoàn tất mới có thể đánh
                                        giá.</span
                                    >
                                </div>
                                <select
                                ...
                                >
                                    <option disabled value="">
                                        Chọn booking đã hoàn tất
                                    </option>
                                    <option
                                        v-for="booking in eligibleReviews"
                                        :key="booking.id"
                                        :value="booking.id"
                                    >
                            ...
                            <textarea
                                ...
                                rows="4"
                                maxlength="2000"
                                placeholder="Điều bạn thích hoặc điều sân cần cải thiện"
                            ></textarea>
                            <p v-if="reviewError" class="error-msg">
                                {{ reviewError }}
                            </p>
                            <button
                                type="submit"
                        ...
                        <p
                            ...
                            "
                            class="review-preview-note"
                        >
                            Hiển thị {{ reviews.length }} đánh giá gần nhất
                            trong tổng số {{ reviewCount }} lượt.
                        </p>
                        <div v-if="reviews.length" class="review-list">
                            ...
                            >
                                <div>
                                    <strong>{{
                                        review.author_name || "Khách hàng"
                                    }}</strong>
                                    <span
                                        >{{
                                            Number(review.rating || 0).toFixed(
                                                1,
                                            )
                                        }}
                                        ★</span
                        ...
                        <p v-else class="muted-text">
                            Sân chưa có đánh giá công khai.
                        </p>
                    </section>
                    ...
                    >
                        ...
                        <div class="location-summary">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                >Chỉ đường <AppIcon name="mapPin" size="15"
                            /></a>
                            <button
                                type="button"
                    ...
                    <section
                        ...
                        "
                        class="detail-section detail-empty-section"
                    >
                        <AppIcon name="fileText" :size="26" />
                        <h2>Thông tin đang được cập nhật</h2>
                        <p class="muted-text">
                            Bạn vẫn có thể xem sân, bảng giá và lịch trống để
                            đặt ngay.
                        </p>
                    </section>
                    ...
                    >
                        ...
                        <p class="muted-text">
                            Hãy nhắn tin với cụm sân để được hướng dẫn đường đi.
                        </p>
                    </section>
                </div>
                ...
                <aside class="booking-panel" ref="bookingPanelRef">
                    <div class="booking-form">
                        <header class="booking-panel-header">
                            <span
                                ><AppIcon name="calendar" size="16" /> Đặt sân
                                nhanh</span
                            >
                            <strong>{{ priceLabel }}</strong>
                            <p>
                                Chọn ngày và khung giờ còn trống trước khi xác
                                nhận.
                            </p>
                        </header>
                        ...
                        <div class="bform-group">
                            <label class="bform-label" for="bp-date"
                                >Ngày chơi</label
                            >
                            <input
                                id="bp-date"
                        ...
                        >
                            <div class="mini-schedule-head">
                                <div>
                                    ...
                                    >
                                        {{ previewAvailableCourtCount }} sân còn
                                        lịch
                                    </span>
                                </div>
                            </div>
                            ...
                            <div
                                v-if="previewLoading"
                                class="mini-schedule-state"
                            >
                                Đang kiểm tra lịch...
                            </div>
                            <div
                                v-else-if="previewError"
                                class="mini-schedule-state error"
                            >
                                {{ previewError }}
                            </div>
                            <div
                                v-else-if="miniScheduleSlots.length"
                                class="mini-slot-list"
                            >
                                <button
...
export default {
    ...
    data() {
        return {
            ...
            error: "",
            gallery: [],
            gallerySourceCount: 0,
            placeholderImage: "/images/home/badminton-cover.webp",
            activeImage: "",
            activeTab: "overview",
            venueTabs: [
    ...
    computed: {
        ...
        amenities() {
            return this.venue?.amenities_detail?.length
        ...
        galleryState() {
            if (this.gallery.length) return "ready";
            return this.gallerySourceCount ? "error" : "missing";
        },
        courtTypeSummary() {
            const names = this.courtTypes
                .map((type) => type.name)
                .filter(Boolean);
        ...
        courtCount() {
            return Number(
                this.venue?.court_count ||
                    this.venue?.venue_courts?.length ||
                    0,
            );
        },
        fullAddress() {
            return (
                [this.venue?.address, this.venue?.ward, this.venue?.province]
                    .filter(Boolean)
        ...
        courtGroups() {
            ...
            (this.venue?.venue_courts || []).forEach((court) => {
                ...
                if (!groups[typeId])
                    groups[typeId] = { typeId, typeName, courts: [] };
        ...
        courtLayoutItems() {
            return (this.venue?.venue_courts || []).map((court, index) => ({
                ...court,
                shortName: String(court.name || `Sân ${index + 1}`).replace(
                    /^Sân\s+/i,
                    "",
                ),
                layoutIndex: index,
        ...
        selectedLayoutCourt() {
            return (
                this.courtLayoutItems.find(
                    (court) => court.id === this.selectedLayoutCourtId,
                ) || null
            );
        },
        ...
        layoutBounds() {
            const items = [
                ...this.courtLayoutItems,
                ...this.layoutDecorationItems,
            ];
            const placedItems = items.filter(
                (item) =>
                    item.layout_x !== null &&
                    item.layout_x !== undefined &&
                    item.layout_y !== null &&
                    item.layout_y !== undefined,
            );
            if (!placedItems.length)
                return { minX: 0, minY: 0, width: 1200, height: 700 };

            const minX = Math.min(
                ...placedItems.map((item) => Number(item.layout_x) || 0),
            );
            const minY = Math.min(
                ...placedItems.map((item) => Number(item.layout_y) || 0),
            );
            const maxX = Math.max(
                ...placedItems.map(
                    (item) =>
                        (Number(item.layout_x) || 0) +
                        Math.max(80, Number(item.layout_w) || 180),
                ),
            );
            const maxY = Math.max(
                ...placedItems.map(
                    (item) =>
                        ...
                        Math.max(60, Number(item.layout_h) || 110),
                ),
            );
            return {
                minX: minX - 80,
                minY: minY - 80,
                width: Math.max(900, maxX - minX + 160),
                height: Math.max(560, maxY - minY + 160),
            };
        },
        layoutCanvasStyle() {
            return {
                aspectRatio: `${this.layoutBounds.width} / ${this.layoutBounds.height}`,
            };
        },
        ...
        policies() {
            ...
            if (policy.allow_full_payment)
                paymentMethods.push("Thanh toán toàn bộ");
            if (policy.allow_wallet) paymentMethods.push("Ví SportGo");
            if (policy.allow_deposit) {
                paymentMethods.push(
                    policy.deposit_percent
                        ? `Đặt cọc ${Number(policy.deposit_percent).toLocaleString("vi-VN")}%`
                        : "Đặt cọc",
                );
            }
            if (policy.allow_no_prepay)
                paymentMethods.push("Thanh toán tại sân");

            return [
                {
                    label: "Giờ hoạt động",
                    value:
                        hours.fixed_open_time && hours.fixed_close_time
                ...
                },
                {
                    ...
                    value: this.durationLabel(
                        policy.min_advance_booking_minutes,
                    ),
                },
                {
                    label: "Hủy và hoàn tiền",
                    value:
                        policy.cancel_before_hours !== null &&
                        policy.cancel_before_hours !== undefined
        ...
        mapEmbedUrl() {
            if (
                this.venue?.map_url &&
                this.venue.map_url.includes("google.com/maps/embed")
            ) {
                return this.venue.map_url;
            }
            if (this.venue?.latitude && this.venue?.longitude) {
                const query = encodeURIComponent(
                    `${this.venue.latitude},${this.venue.longitude}`,
                );
        ...
        mapExternalUrl() {
            ...
            if (
                this.venue?.map_url &&
                /^https?:\/\//i.test(this.venue.map_url)
            ) {
                return this.venue.map_url;
            }
            if (
                this.fullAddress &&
                this.fullAddress !== "Đang cập nhật địa chỉ"
            ) {
        ...
        phoneUrl() {
            const phone = String(this.venue?.phone_contact || "").replace(
                /[^\d+]/g,
                "",
            );
                ...
                .map((slot) => {
                    const slotStatuses = statuses.filter(
                        (status) =>
                            ...
                            courts.some(
                                (court) => court.id === status.venue_court_id,
                            ),
                    );
                    const available = slotStatuses.filter(
            ...
            const availableCourtIds = new Set(
                (this.previewSchedule.slot_statuses || [])
                    .filter(
                        (status) =>
                            status.is_available &&
                            visibleStartTimes.has(status.start_time),
                    )
    ...
    mounted() {
        ...
        this.bookDate = this.normalizeBookingDate(
            this.$route.query.booking_date || this.$route.query.date,
        );
        this.bookCourtType =
            this.$route.query.court_type_id ||
            this.$route.query.court_type ||
            "";
        this.fetchVenue();
    },
    ...
    methods: {
        normalizeBookingDate(value) {
            ...
            if (!/^\d{4}-\d{2}-\d{2}$/.test(candidate) || candidate < today)
                return today;
            const date = new Date(`${candidate}T00:00:00`);
            if (
                Number.isNaN(date.getTime()) ||
                date.toLocaleDateString("en-CA") !== candidate
            )
                return today;
            return candidate;
        },
        normalizeTab(tab) {
            ...
            return this.venueTabs.some((item) => item.id === value)
                ? value
                : "overview";
        },
        ...
        courtLayoutStyle(court) {
            const hasLayout =
                court.layout_x !== null &&
                court.layout_x !== undefined &&
                court.layout_y !== null &&
                court.layout_y !== undefined;
            ...
            const left =
                (((hasLayout ? Number(court.layout_x) : fallbackX) -
                    this.layoutBounds.minX) /
                    this.layoutBounds.width) *
                100;
            const top =
                (((hasLayout ? Number(court.layout_y) : fallbackY) -
                    this.layoutBounds.minY) /
                    this.layoutBounds.height) *
                100;
            const width = Math.max(
                8,
                (Number(court.layout_w || 180) / this.layoutBounds.width) * 100,
            );
            const height = Math.max(
                8,
                (Number(court.layout_h || 110) / this.layoutBounds.height) *
                    100,
            );
            return {
        ...
        async fetchVenue() {
            ...
            try {
                ...
                this.gallerySourceCount = g.length;
                this.gallery = [
                    ...new Set(
                        g.map((path) => this.imageUrl(path)).filter(Boolean),
                    ),
                ];
        ...
        async copyVenueAddress() {
            ...
            try {
                ...
                this.toast.error(
                    "Không thể sao chép địa chỉ trên thiết bị này.",
                );
            }
        },
        ...
        async shareVenue() {
            ...
            const shareData = {
                ...
                text: `${this.venue.name} · ${this.fullAddress}`,
            ...
            try {
                if (navigator.share) await navigator.share(shareData);
                    ...
                    this.toast.success("Đã sao chép liên kết sân.");
                }
            } catch (error) {
                if (error?.name !== "AbortError")
                    this.toast.error("Không thể chia sẻ sân lúc này.");
            }
        },
        ...
        async toggleFavorite() {
            ...
            try {
                ...
                this.toast.success(
                    response.message ||
                        (this.isFavorite ? "Đã lưu sân." : "Đã bỏ lưu sân."),
                );
            } catch (error) {
                this.toast.error(
        ...
        imageUrl(path) {
            return normalizeMediaUrl(
                typeof path === "object" ? path : { file_path: path },
            );
        },
            ...
            try {
                ...
                if (!response.ok) {
                    ...
                    if (response.status === 422) {
                        ...
                        throw new Error(
                            firstError || "Thông tin không hợp lệ.",
                        );
                    }
                ...
                if (this.$refs.reportEvidence)
                    this.$refs.reportEvidence.value = "";
            } catch (err) {
        ...
        goToBooking(slot = null) {
            ...
            if (slot?.venue_court_id)
                query.venue_court_id = slot.venue_court_id;
        ...
        requirePlayer() {
            ...
            if (!auth) {
                this.toast.info(
                    "Vui lòng đăng nhập để sử dụng chức năng hỗ trợ.",
                );
                this.$router.push({
                    name: "login",
        ...
        onComplaintSuccess() {
            ...
            this.toast.success(
                "Khiếu nại đã được ghi nhận. SportGo sẽ phản hồi sau khi kiểm tra.",
            );
        },
        ...
        onReportSuccess() {
            this.showReportModal = false;
            this.toast.success(
                "Báo cáo đã được ghi nhận để đội ngũ SportGo kiểm tra.",
            );
        },
    },
};
