<template>
    <section class="vip-page">
        ...
        <div v-if="hasActiveSubscription" class="alert info">
            Bạn đang có gói VIP còn hiệu lực. Hệ thống chỉ cho phép dùng 1 gói
            VIP tại một thời điểm.
        </div>
        ...
        >
            <div class="payment-copy">
                ...
                <small
                    >Chuyển đúng số tiền và nội dung để hệ thống tự kích hoạt
                    gói VIP.</small
                >
            </div>
            <img
        ...
        <section v-else class="plan-grid">
            ...
            >
                ...
                <ul>
                    <li>
                        Hoàn tiền {{ pkg.cashback_percent }}% sau booking hoàn
                        tất
                    </li>
