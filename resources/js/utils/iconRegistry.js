export const ICON_REGISTRY = {
  ...
  badminton: [
    ...
    ['path', { d: 'M15 9 5 19M8 22l9-9M3 20l2 2M9 6l4 4' }],
  ],
  pickleball: [
  ...
  football: [
    ...
    ['polygon', { points: '12 7.5 9.5 9.5 10.5 13 13.5 13 14.5 9.5' }],
    ['line', { x1: 12, y1: 3, x2: 12, y2: 7.5 }],
    ['line', { x1: 4.5, y1: 7, x2: 9.5, y2: 9.5 }],
    ['line', { x1: 19.5, y1: 7, x2: 14.5, y2: 9.5 }],
    ['line', { x1: 6.5, y1: 17, x2: 10.5, y2: 13 }],
    ['line', { x1: 17.5, y1: 17, x2: 13.5, y2: 13 }],
  ],
  basketball: [
    ['circle', { cx: 12, cy: 12, r: 9 }],
    ['path', { d: 'M5.6 5.6c4.7 2 8.8 6.1 10.8 10.8M18.4 5.6c-4.7 2-8.8 6.1-10.8 10.8M3 12h18M12 3v18' }],
  ],
  tennis: [
    ['circle', { cx: 12, cy: 12, r: 9 }],
    ['path', { d: 'M5.5 5.5c2.7 1 4.1 3.1 4.1 6.5s-1.4 5.5-4.1 6.5M18.5 5.5c-2.7 1-4.1 3.1-4.1 6.5s1.4 5.5 4.1 6.5' }],
  ],
  volleyball: [
    ['circle', { cx: 12, cy: 12, r: 9 }],
