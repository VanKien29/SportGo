    ...
    >
        ...
        <template v-if="sidebarStyle === 'one-level'">
            ...
            <nav class="sidebar-nav">
                ...
                >
                    <p v-if="!collapsed" class="nav-group">
                        {{ section.label }}
                    </p>
                ...
                <div class="icon-nav-rail">
                    ...
                    <div v-if="showUtilityNavigation" class="rail-bottom">
                        <RouterLink
                            ...
                            class="rail-icon-btn"
                            :class="{
                                active: activeRouteName === 'owner-chat',
                            }"
                            to="/owner/chat"
                            title="Tin nhắn"
                        >
...
export default {
    ...
    data() {
        return {
            sidebarStyle:
                localStorage.getItem("owner-sidebar-style") || "one-level",
            localActiveSectionIndex: null,
        };
    },
    mounted() {
        window.addEventListener(
            "owner-sidebar-style-changed",
            this.loadSidebarStyle,
        );
    },
    beforeUnmount() {
