    ...
    <div style="max-width:640px;margin:0 auto;padding:28px 16px">
        <div style="border:1px solid #d7e5dc;background:#ffffff;border-radius:12px;overflow:hidden">
            <div style="padding:18px 22px;background:#16a34a;color:#ffffff">
                ...
                <div style="font-size:13px;opacity:.9;margin-top:4px">Phiếu tài chính đã được phát hành</div>
            </div>
            <div style="padding:24px 22px;line-height:1.6">
                ...
                <p style="margin:0 0 18px">SportGo đã phát hành phiếu tài chính cho giao dịch sau:</p>

                <table style="width:100%;border-collapse:collapse;margin:0 0 20px">
                    <tr>
                        <td style="padding:10px 0;border-bottom:1px solid #edf2ef;color:#617067">Mã phiếu</td>
                ...
                <a href="{{ $receiptUrl }}" style="display:inline-block;background:#16a34a;color:#ffffff;text-decoration:none;padding:12px 18px;border-radius:8px;font-weight:800">Xem phiếu</a>
                <p style="margin:18px 0 0;color:#617067;font-size:13px">Liên kết xem phiếu có hiệu lực trong 30 ngày.</p>
            </div>
        </div>
    </div>
</body>
