...
<body style="margin:0;background:#f6f7f9;font-family:Arial,sans-serif;color:#111827;">
    <div
        style="max-width:620px;margin:32px auto;background:#ffffff;border-radius:12px;padding:32px;border:1px solid #e5e7eb;">
        ...
        <p>Mã có hiệu lực trong {{ $minutes }} phút. Không cung cấp mã này cho bất kỳ ai. Nếu nội dung văn bản thay đổi,
            mã OTP này sẽ hết hiệu lực.</p>
