...
class AdminUiSettingsController extends Controller
{
    ...
    private function themePresets(): array
    {
        return [
            ...
            [
                ...
                'name' => 'Rose',
                'color' => '#e11d48',
                'light' => ['primary' => '#e11d48', 'secondary' => '#be123c', 'accent' => '#fff1f2', 'muted' => '#64748b', 'destructive' => '#991b1b', 'border' => '#fecdd3', 'card' => '#ffffff', 'background' => '#fff7f8'],
                'dark' => ['primary' => '#fb7185', 'secondary' => '#f43f5e', 'accent' => '#4c0519', 'muted' => '#94a3b8', 'destructive' => '#f87171', 'border' => '#881337', 'card' => '#1f1015', 'background' => '#10070a'],
            ],
        ];
    }
    ...
    private function mergeSettings(array $stored): array
    {
        ...
        foreach ($defaults['presets'] as $preset) {
            $presetMap[$preset['id']] = $preset;
        }

        $storedPresets = is_array($stored['presets'] ?? null) ? $stored['presets'] : [];

        foreach ($storedPresets as $preset) {
