...
class BookingConfigController extends Controller
{
    ...
    public function update(Request $request, string $venueClusterId): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'custom_time_periods' => ['sometimes', 'nullable', 'array', 'max:10'],
            'custom_time_periods.*.label' => ['required_with:custom_time_periods', 'string', 'max:50'],
            'custom_time_periods.*.start_time' => ['required_with:custom_time_periods', 'date_format:H:i'],
            'custom_time_periods.*.end_time' => ['required_with:custom_time_periods', 'regex:/^(?:([01]\d|2[0-3]):[0-5]\d|24:00)$/'],
    ...
    private function configPayload(?BookingConfig $config, string $clusterId): array
    {
        return [
            ...
            'custom_time_periods' => $config?->custom_time_periods ?? [],
